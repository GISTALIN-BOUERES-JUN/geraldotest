            ...
            <Modal isOpen={isModalOpen} onRequestClose={handleCloseModal} overlayClassName="react-modal-overlay" className="react-modal_content">
                <Box flex="1" borderRadius={8}  p="8" bg="#e7e9ee" alignContent="center">
                    ...
                    <FormControl id='email'>
                        <Input placeholder="E-Mail" type="email" mb="2" color="black" value={email} onChange={event => setEmail(event.target.value)} ></Input>
                    </FormControl>

                    <Input placeholder="Phone Number" type="number" mb="4" color="black" value={phoneNumber} onChange={event => setPhoneNumber(event.target.value)}></Input>
